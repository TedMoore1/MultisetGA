...
import org.evosuite.ga.multisetga.MultisetGA;
import org.evosuite.ga.multisetga.MultisetTestFitnessFactory;
...
public class MultisetStrategy extends TestGenerationStrategy {
    @Override
    public TestSuiteChromosome generateTests() {
        // MultisetGA will maintain its own archive.
        Properties.TEST_ARCHIVE = false;

        // MultisetGA does its own minimization.
        Properties.MINIMIZE = false;

        // MultisetGA does not need assertions.
        ...
        MultisetGA<TestChromosome> geneticAlgorithm = new MultisetGA<>(new RandomLengthTestFactory());
        List<TestFitnessFunction> goals = MultisetTestFitnessFactory.getGoals();
