...
public class MultisetFitnessFunction extends TestFitnessFunction {
    ...
    public MultisetFitnessFunction(BytecodeInstruction node, String instrumentationId) {
        this.node = node;
    ...
    public int compareTo(TestFitnessFunction other) {
        if (other instanceof MultisetFitnessFunction) {
            // Check if this is a control dependency? of the other one.
            MultisetFitnessFunction otherff = (MultisetFitnessFunction) other;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MultisetFitnessFunction)) return false;
        MultisetFitnessFunction otherMultiset = (MultisetFitnessFunction) other;

        return this.id.equals(otherMultiset.id) && this.node.equals(otherMultiset.node);
    }
